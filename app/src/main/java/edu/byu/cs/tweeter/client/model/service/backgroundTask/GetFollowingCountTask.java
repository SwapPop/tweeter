...
public class GetFollowingCountTask extends CountTask {
    ...
    public GetFollowingCountTask(FollowService followService, AuthToken authToken, User targetUser, Handler messageHandler) {
    ...
    protected void runTask() {
        try {
            ...
            GetFollowingCountResponse response = followService.getServerFacade().getFollowingCount(request, URL_PATH);
